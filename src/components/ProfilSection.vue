...
const people = [
  {
    ...
    details: ['Putra ke-2 dari Bapak dan Ibu Saputra', 'Berikhtiar membangun keluarga Qurani', 'Lulusan Teknik Informatika'],
  },
  {
    ...
    details: ['Putri pertama dari Bapak dan Ibu Annisa', 'Berkomitmen menjaga ilmu dan adab', 'Lulusan Pendidikan Islam'],
  },
]

// TODO: pasang stagger reveal pada kartu profil dengan ScrollTrigger.
</script>
